                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <select name="course" id="course" class="custom-select select2">
                            ...
                            <?php 
                            $sections = $conn->query("SELECT * FROM courses WHERE dept_id = '$dept_id' ORDER BY id ASC"); // Filter by dept_id
                        ...
                        <select name="sec_id" id="sec_id" class="custom-select select2">
                            ...
                            <?php 
                            $sections = $conn->query("SELECT * FROM section WHERE dept_id = '$dept_id' ORDER BY year ASC"); // Filter by dept_id
                            while($row= $sections->fetch_array()):
                            ?>
                                ...
                                <table class="table table-bordered table-hover" id="insloadtable">
                                    ...
                                    <?php
                                        ...
                                        if(isset($_GET['secid']) && isset($_GET['semester'])){
                                            ...
                                            $loads = $conn->query("SELECT * FROM loading WHERE dept_id = '$dept_id' ORDER BY timeslot_sid ASC"); // Filter by dept_id
                                        }

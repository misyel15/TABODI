                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="sec_id" id="sec_id" class="custom-select select2">
                            ...
                            <?php 
                            // Fetch sections by department ID
                        ...
                        <select name="semester" id="semester" class="form-control">
                            ...
                            <?php 
                            $sql = "SELECT * FROM semester"; // Assuming semester is not department-specific
                                ...
                                <table class="table table-bordered table-hover" id="insloadtable">
                                    ...
                                    <?php
                                        ...
                                        if (isset($_GET['secid']) && isset($_GET['semester'])) {
                                            ...
                                            // Include department ID in loading query
                                            ...
                                            // You can decide whether to filter by department in this case

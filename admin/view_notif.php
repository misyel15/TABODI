                        ...
                        <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                            <div class="au-card-title" style="background-image:url('<?php echo $data['Image'] ?>');">
                                ...
                                <h3>
                                    ...
                                    <i class="zmdi zmdi-notifications"></i>Notifications</h3>
                            </div>
                            ...
                            // Corrected SQL query to avoid ambiguity
                            $query = mysqli_prepare($bd, "SELECT s.name, s.username, n.message, n.timestamp, s.course
                                                          FROM users s

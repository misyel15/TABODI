...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="home.php"><img src="assets/uploads/mcclogo.jpg" alt="Mcc Faculty Scheduling" /></a>
            </div>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                ...
                <h1>Welcome to Mcc Faculty Scheduling</h1>
                <p>Your main content will be displayed here.</p>
            </div>
            <!-- END MAIN CONTENT-->
        </div>
        <!-- END PAGE CONTAINER-->
    ...
    <script>
        // JavaScript function to mark notification as read
        function markAsRead(notifId) {
            const xhttp = new XMLHttpRequest();
            xhttp.open("GET", "notif.php?mark_read=" + notifId, true);
            xhttp.send();
        }
    </script>
</body>

...
<!-- Add this modal for editing records just before the closing </body> tag -->
      ...
      <form id="editScheduleForm">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <select name="faculty" id="edit_faculty" class="form-control select2">
              <?php 
              $faculty = $conn->query("SELECT *, concat(lastname, ', ', firstname, ' ', middlename) as name 
                                       FROM faculty 
                                       WHERE dept_id = '$dept_id' 
          ...
          <div class="form-group">
            ...
            <select name="semester" id="edit_semester" class="form-control">
              ...
              while ($row = $query->fetch_array()):
              ?>
                <option value="<?php echo $row['sem'] ?>"><?php echo ucwords($row['sem']) ?></option>
              <?php endwhile; ?>
            </select>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="edit_yrsection">Section</label>
            <select name="yrsection" id="edit_yrsection" class="form-control" required>
              <?php 
              $sql = "SELECT * FROM section WHERE dept_id = '$dept_id' ORDER BY year ASC, section ASC";
              $query = $conn->query($sql);
              while ($row = $query->fetch_array()):
              ...
              ?>
                <option value="<?php echo htmlspecialchars($yr_section_value) ?>"><?php echo ucwords(htmlspecialchars($yr_section_display)) ?></option>
              <?php endwhile; ?>
            </select>
          </div>
          <div class="form-group">
            ...
            <select name="subject" id="edit_subject" class="form-control" required>
              ...
              while ($row = $query->fetch_array()):
              ?>
                <option value="<?php echo htmlspecialchars($row['subject']) ?>"><?php echo ucwords(htmlspecialchars($row['subject'])) ?></option>
              <?php endwhile; ?>
            </select>
          </div>
          <div class="form-group">
            ...
            <select name="room" id="edit_room" class="form-control" required>
              ...
              while ($row = $query->fetch_array()):
              ?>
                <option value="<?php echo htmlspecialchars($row['room_name']) ?>"><?php echo ucwords(htmlspecialchars($row['room_name'])) ?></option>
              <?php endwhile; ?>
            </select>
          </div>
          <div class="form-group">
            <label for="edit_days">Days of Week</label>
            <select name="days" id="edit_days" class="form-control">
              <?php 
              $sql = "SELECT * FROM days";
              $query = $conn->query($sql);
              while ($row = $query->fetch_array()):
              ?>
                <option value="<?php echo htmlspecialchars($row['days']) ?>"><?php echo ucwords(htmlspecialchars($row['days'])) ?></option>
              <?php endwhile; ?>
            </select>
          </div>
          <div class="form-group">
            <label for="edit_timeslot">Timeslot</label>
            <select name="timeslot" id="edit_timeslot" class="form-control" required>
              ...
              while ($row = $query->fetch_array()):
              ?>
                <option value="<?php echo htmlspecialchars($row['timeslot']) ?>"><?php echo ucwords(htmlspecialchars($row['timeslot']." ".$row['schedule'])) ?></option>
              <?php endwhile; ?>
            </select>
          </div>
        </div>
